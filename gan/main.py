...
for epoch in range(params['epochs']):
    ...
    for i, data in enumerate(training_loader, 0):
        ...
        fake_underwater, g_loss, d_loss = train(generator, discriminator, in_air, underwater, loss_function, device)
    ...
    for i, data in enumerate(validation_loader, 0):
        ...
        d_loss = validate_d(generator, discriminator, in_air, underwater, loss_function, device)
